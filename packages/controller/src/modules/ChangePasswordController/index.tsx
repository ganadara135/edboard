...
interface Props {
    children: 
        (data: {submit: (values: ForgotPasswordChangeMutationVariables) 
            => Promise<NormalizedErrorMap | null>})
     => JSX.Element | null;
}

class C extends React.PureComponent<
 ChildMutateProps<Props, any, ForgotPasswordChangeMutationVariables>
> {
...
>(FORGOT_PASSWORD_CHANGE_MUTATION)(C);